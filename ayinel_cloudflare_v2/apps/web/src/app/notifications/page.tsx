...
export default function NotificationsPage() {
    ...
    const mockNotifications: Notification[] = [
      ...
      },
      {
        ...
        video: {
          ...
          thumbnail:
            'https://images.unsplash.com/photo-1611162617213-7d7a39e9b1d7?w=100&h=56&fit=crop',
        },
  ...
  const filteredNotifications = notifications.filter((notification) => {
    ...
    if (activeFilter === 'tune_ins')
      return notification.type.includes('tune_in');
