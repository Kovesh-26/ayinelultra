  ...
  const featuredContent = [
    {
      ...
      duration: '12:45',
      thumbnail:
        'https://via.placeholder.com/320x180/6366f1/ffffff?text=Ayinel+Studio',
      category: 'Tech',
    },
    {
      id: 2,
      ...
      duration: 'LIVE',
      thumbnail:
        'https://via.placeholder.com/320x180/ef4444/ffffff?text=Live+Coding',
      category: 'Tech',
    },
    {
      id: 3,
      ...
      duration: '1:23:45',
      thumbnail:
        'https://via.placeholder.com/320x180/10b981/ffffff?text=Gaming',
      category: 'Gaming',
    },
  ];
