...
export default function DashboardPage() {
  ...
  const [stats, setStats] = useState<Stats>({ totalViews: 0, totalBoosts: 0, totalCrew: 0, totalVideos: 0 });
      ...
      try {
        ...
        if (studioResponse) {
          ...
          const [videosResponse, statsResponse] = await Promise.all([
            api.get(endpoints.videos.list + '?studioId=' + studioResponse.data.id),
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6 border border-white/20">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                <p className="text-sm font-medium text-purple-200">Total Boosts</p>
                <p className="text-2xl font-bold text-white">{stats.totalBoosts.toLocaleString()}</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6 border border-white/20">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                <p className="text-sm font-medium text-purple-200">Crew Members</p>
                <p className="text-2xl font-bold text-white">{stats.totalCrew.toLocaleString()}</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white/10 backdrop-blur-sm rounded-lg p-6 border border-white/20">
            <div className="flex items-center">
              ...
              <div className="ml-4">
                <p className="text-sm font-medium text-purple-200">Total Videos</p>
        ...
        {!studio && (
          <div className="bg-white/10 backdrop-blur-sm rounded-lg p-8 border border-white/20 text-center">
            ...
            <h3 className="text-xl font-semibold text-white mb-2">Ready to start creating?</h3>
            <p className="text-purple-200 mb-6">
              Create your studio to start uploading videos and building your crew.
            </p>
            <Link
              href="/studio/create"
              className="bg-gradient-to-r from-purple-600 to-blue-600 hover:from-purple-700 hover:to-blue-700 text-white font-semibold py-3 px-6 rounded-lg transition-all duration-300"
