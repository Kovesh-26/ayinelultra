...
export default function WatchPage() {
  ...
  useEffect(() => {
    const mockVideo: Video = {
      ...
      description:
        "Join us as we explore the incredible features of Ayinel, the next-generation video platform. From Tune-In relationships to Boost interactions, discover how we're revolutionizing content creation and consumption. #Ayinel #VideoPlatform #Innovation",
      thumbnail:
    ...
    const mockComments: Comment[] = [
      {
        id: 'comment-1',
        content:
          "This platform looks incredible! The Tune-In feature is genius. Can't wait to see more creators join!",
        ...
        replies: [
          {
            id: 'reply-1',
            content:
              'Absolutely! The token economy makes it feel more valuable.',
    ...
    const mockRelatedVideos: Video[] = [
      {
        ...
        thumbnail:
          'https://images.unsplash.com/photo-1516321318423-f06f85e504b3?w=300&h=169&fit=crop',
        duration: 892,
        views: 8234,
      ...
      },
      {
        ...
        thumbnail:
          'https://images.unsplash.com/photo-1621761191319-c6fb62004040?w=300&h=169&fit=crop',
        duration: 654,
        views: 5678,
