  ...
  useEffect(() => {
    ...
    const mockTrendingVideos: TrendingVideo[] = [
      ...
      },
      {
        ...
        thumbnail:
          'https://images.unsplash.com/photo-1621761191319-c6fb62004040?w=320&h=180&fit=crop',
        duration: 654,
        views: 34200,
        boosts: 1890,
      ...
      },
      {
        ...
        thumbnail:
          'https://images.unsplash.com/photo-1556909114-f6e7ad7d3136?w=320&h=180&fit=crop',
        duration: 1200,
        views: 28900,
        boosts: 1560,
    ...
    const mockTrendingCreators: TrendingCreator[] = [
      {
        ...
        banner:
          'https://images.unsplash.com/photo-1611162617213-7d7a39e9b1d7?w=400&h=150&fit=crop',
      ...
      },
      {
        ...
        banner:
          'https://images.unsplash.com/photo-1511512578047-dfb367046420?w=400&h=150&fit=crop',
      ...
      },
      {
        ...
        banner:
          'https://images.unsplash.com/photo-1516321318423-f06f85e504b3?w=400&h=150&fit=crop',
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
          <div className="flex items-center justify-between">
            ...
            <nav className="flex space-x-6">
              ...
              <Link href="/trending" className="text-purple-400 font-medium">
                Trending
              </Link>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-400">
            Discover what's popular on Ayinel right now
          </p>
        </div>
                      ...
                      <div className="grid grid-cols-4 gap-4 mb-4">
                        <div className="text-center">
                          <div className="text-lg font-bold text-white">
                            {formatViews(creator.crew)}
                          </div>
                          <div className="text-gray-400 text-xs">Crew</div>
                        </div>
                        <div className="text-center">
                          <div className="text-lg font-bold text-white">
                            {formatViews(creator.tuneIns)}
                          </div>
