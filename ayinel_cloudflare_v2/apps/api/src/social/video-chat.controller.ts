...
export class VideoChatController {
  ...
  async createVideoChat(@Req() req, @Body() dto: CreateVideoChatDto): Promise<VideoChatResponseDto> {
  ...
  async updateVideoChat(@Req() req, @Param('chatId') chatId: string, @Body() dto: UpdateVideoChatDto): Promise<VideoChatResponseDto> {
  ...
  async deleteVideoChat(@Req() req, @Param('chatId') chatId: string): Promise<void> {
  ...
  async getVideoChats(@Param('videoId') videoId: string, @Query('parentId') parentId?: string): Promise<VideoChatResponseDto[]> {
  ...
  async getVideoChatCount(@Param('videoId') videoId: string): Promise<{ count: number }> {
