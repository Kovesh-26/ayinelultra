...
export class ConsoleController {
  ...
  async createConsoleIntegration(@Req() req, @Body() dto: ConsoleIntegrationDto): Promise<ConsoleIntegrationResponseDto> {
  ...
  async getUserIntegrations(@Req() req): Promise<ConsoleIntegrationResponseDto[]> {
  ...
  async getConsoleIntegration(@Param('id') id: string, @Req() req): Promise<ConsoleIntegrationResponseDto> {
  ...
  async updateConsoleIntegration(@Param('id') id: string, @Req() req, @Body() dto: ConsoleIntegrationDto): Promise<ConsoleIntegrationResponseDto> {
  ...
  async deleteConsoleIntegration(@Param('id') id: string, @Req() req): Promise<void> {
  ...
  @ApiResponse({ status: 200, description: 'Console integration status toggled' })
  async toggleIntegrationStatus(@Param('id') id: string, @Req() req): Promise<ConsoleIntegrationResponseDto> {
  ...
  async syncProducts(@Param('id') integrationId: string, @Req() req): Promise<any> {
  ...
  async getPlatformCategories(@Param('platform') platform: string): Promise<any[]> {
  ...
  async getIntegrationStats(@Param('id') integrationId: string, @Req() req): Promise<any> {
