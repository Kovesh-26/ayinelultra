      ...
      <div className="min-h-screen bg-black flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-400">
            Preparing your next-level dashboard...
          </p>
            ...
            <div className="flex items-center space-x-8">
              ...
              <div>
                ...
                <p className="text-gray-300 text-lg">
                  @{user.handle} • {currentTime.toLocaleTimeString()}
                </p>
              </div>
            </div>
      ...
      <div className="max-w-7xl mx-auto px-8 py-10 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-6 gap-6 mb-12">
          {[
            ...
            {
              label: 'Total Likes',
              value: liveStats.likes.toLocaleString(),
              icon: '❤️',
              color: 'from-red-500 to-pink-500',
              trend: '+8%',
            },
            ...
            {
              label: 'Earnings',
              value: `$${liveStats.earnings.toFixed(2)}`,
              icon: '💰',
              color: 'from-yellow-500 to-orange-500',
              trend: '+18%',
            },
            {
              label: 'Followers',
              value: liveStats.followers.toLocaleString(),
              icon: '👑',
            ...
            >
              <div className="flex items-center justify-between mb-4">
                <div
                  className={`w-12 h-12 rounded-2xl bg-gradient-to-r ${stat.color} flex items-center justify-center text-2xl shadow-lg`}
                >
                  {stat.icon}
                </div>
                <div className="text-right">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 mb-12">
          {[
            ...
            >
              <div className="flex items-center space-x-6">
                <div
                  className={`w-16 h-16 rounded-2xl bg-gradient-to-r ${action.color} flex items-center justify-center text-3xl group-hover:scale-110 transition-transform duration-300 shadow-lg`}
                >
                  {action.icon}
                </div>
                <div>
        ...
        <div className="bg-gradient-to-br from-gray-900/50 to-purple-900/20 rounded-3xl p-8 border border-purple-500/30 backdrop-blur-sm">
          ...
          <div className="space-y-4">
            {recentActivity.map((activity, index) => (
              ...
              >
                <div
                  className={`w-12 h-12 rounded-xl bg-gradient-to-r ${activity.color} flex items-center justify-center text-xl shadow-lg`}
                >
                  {activity.icon}
                </div>
